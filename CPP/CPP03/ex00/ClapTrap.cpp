...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/31 13:01:35 by jkarras           #+#    #+#             */
/*   Updated: 2025/07/31 13:01:40 by jkarras          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount) {
	if (this->_hitPoints > 0 && this->_energyPoints > 0 && this->_hitPoints + amount <= 10) {
		...
		std::cout << "ClapTrap " << this->_name << " can't be repaired to have more than 10 hitpoints. It repaird himself to 10 hitpoints\n";
		this->_hitPoints = 10;
	}
}
